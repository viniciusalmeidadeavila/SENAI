...
public class Conexao {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/Exercicio1?useTimezone=true&serverTimezone=UTC";
    private static final String USUARIO = "root"; // Troque pelo seu usuário do MySQL
    private static final String SENHA = "";       // Troque pela sua senha do MySQL (se houver)
